...
{
    [TestClass]
    public sealed class AzureRmThirdPartyDomainCertificateHandler_CertificateRestored_Tests : AzureRmThirdPartyDomainCertificateHandlerTestBase
    {
        [TestInitialize]
        public void Prep()
        {
        ...
        public async Task ThrowsWhenWebAppNameNotMatched()
        {
            ...
            await Assert.ThrowsExceptionAsync<InvalidOperationException>(async () => await subject.CertificateRestored(cert, pfx, "test"));
        }
        ...
        public async Task CertNotCreatedWhenCertAlreadyExists()
        {
            ...
            var subject = new AzureRmThirdPartyDomainCertificateHandler(mockOpts.Object, mockCertOpts.Object, mockLogger.Object, mocks.MockAzureFactory.Object);
            await subject.CertificateRestored(cert, pfx, "test");
